...
export class ReceivableCreated extends DomainEvent<{ receivableId: string, customerReference: string, originalAmount: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { receivableId: string, customerReference: string, originalAmount: number }, metadata: EventMetadata = {}) {
...
export class InvoiceIssued extends DomainEvent<{ receivableId: string, invoiceReference: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { receivableId: string, invoiceReference: string }, metadata: EventMetadata = {}) {
...
export class PaymentAllocated extends DomainEvent<{ receivableId: string, paymentReference: string, amount: number, outstandingBalance: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { receivableId: string, paymentReference: string, amount: number, outstandingBalance: number }, metadata: EventMetadata = {}) {
...
export class PartialPaymentRecorded extends DomainEvent<{ receivableId: string, amount: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { receivableId: string, amount: number }, metadata: EventMetadata = {}) {
...
export class ReceivableClosed extends DomainEvent<{ receivableId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { receivableId: string }, metadata: EventMetadata = {}) {
...
export class ReceivableWrittenOff extends DomainEvent<{ receivableId: string, amount: number, approverId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { receivableId: string, amount: number, approverId: string }, metadata: EventMetadata = {}) {
...
export class ReceivableReopened extends DomainEvent<{ receivableId: string, reason: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { receivableId: string, reason: string }, metadata: EventMetadata = {}) {
