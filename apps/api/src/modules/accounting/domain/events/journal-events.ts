...
export class JournalCreated extends DomainEvent<{ journalId: string, journalNumber: string, currency: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journalId: string, journalNumber: string, currency: string }, metadata: EventMetadata = {}) {
...
export class JournalApproved extends DomainEvent<{ journalId: string, approverId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journalId: string, approverId: string }, metadata: EventMetadata = {}) {
...
export class JournalPosted extends DomainEvent<{ journalId: string, postingDate: Date }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journalId: string, postingDate: Date }, metadata: EventMetadata = {}) {
...
export class JournalReversed extends DomainEvent<{ journalId: string, reversedBy: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journalId: string, reversedBy: string }, metadata: EventMetadata = {}) {
...
export class JournalVoided extends DomainEvent<{ journalId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journalId: string }, metadata: EventMetadata = {}) {
