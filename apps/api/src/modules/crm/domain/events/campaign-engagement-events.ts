...
export class CampaignEngagementCreated extends DomainEvent<{ engagementId: string, campaignReference: string, targetReference: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { engagementId: string, campaignReference: string, targetReference: string }, metadata: EventMetadata = {} as any) {
...
export class CampaignOpened extends DomainEvent<{ engagementId: string, userAgent: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { engagementId: string, userAgent: string }, metadata: EventMetadata = {} as any) {
...
export class CampaignClicked extends DomainEvent<{ engagementId: string, linkId: string, url: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { engagementId: string, linkId: string, url: string }, metadata: EventMetadata = {} as any) {
...
export class CampaignVisited extends DomainEvent<{ engagementId: string, pageUrl: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { engagementId: string, pageUrl: string }, metadata: EventMetadata = {} as any) {
...
export class CampaignConverted extends DomainEvent<{ engagementId: string, conversionType: string, value: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { engagementId: string, conversionType: string, value: number }, metadata: EventMetadata = {} as any) {
...
export class CampaignUnsubscribed extends DomainEvent<{ engagementId: string, reason: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { engagementId: string, reason: string }, metadata: EventMetadata = {} as any) {
...
export class CampaignEngagementClosed extends DomainEvent<{ engagementId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { engagementId: string }, metadata: EventMetadata = {} as any) {
