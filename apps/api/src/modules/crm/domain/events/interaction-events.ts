...
export class InteractionCreated extends DomainEvent<{ interactionId: string, channel: string, type: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { interactionId: string, channel: string, type: string }, metadata: EventMetadata = {} as any) {
...
export class InteractionAssigned extends DomainEvent<{ interactionId: string, assigneeId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { interactionId: string, assigneeId: string }, metadata: EventMetadata = {} as any) {
...
export class InteractionOutcomeRecorded extends DomainEvent<{ interactionId: string, outcome: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { interactionId: string, outcome: string }, metadata: EventMetadata = {} as any) {
...
export class InteractionNoteAdded extends DomainEvent<{ interactionId: string, authorId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { interactionId: string, authorId: string }, metadata: EventMetadata = {} as any) {
...
export class FollowUpScheduled extends DomainEvent<{ interactionId: string, scheduledDate: Date, assignedTo: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { interactionId: string, scheduledDate: Date, assignedTo: string }, metadata: EventMetadata = {} as any) {
...
export class InteractionClosed extends DomainEvent<{ interactionId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { interactionId: string }, metadata: EventMetadata = {} as any) {
