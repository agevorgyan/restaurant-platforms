...
export class OpportunityCreated extends DomainEvent<{ opportunityId: string, leadId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { opportunityId: string, leadId: string }, metadata: EventMetadata = {}) {
...
export class OpportunityAssigned extends DomainEvent<{ opportunityId: string, assigneeId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { opportunityId: string, assigneeId: string }, metadata: EventMetadata = {}) {
...
export class OpportunityStageChanged extends DomainEvent<{ opportunityId: string, oldStage: string, newStage: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { opportunityId: string, oldStage: string, newStage: string }, metadata: EventMetadata = {}) {
...
export class OpportunityRevenueUpdated extends DomainEvent<{ opportunityId: string, newRevenue: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { opportunityId: string, newRevenue: number }, metadata: EventMetadata = {}) {
...
export class OpportunityWon extends DomainEvent<{ opportunityId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { opportunityId: string }, metadata: EventMetadata = {}) {
...
export class OpportunityLost extends DomainEvent<{ opportunityId: string, reason: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { opportunityId: string, reason: string }, metadata: EventMetadata = {}) {
