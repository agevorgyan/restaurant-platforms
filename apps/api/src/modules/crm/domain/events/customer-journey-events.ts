...
export class JourneyCreated extends DomainEvent<{ journeyId: string, customerReference: string, journeyType: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journeyId: string, customerReference: string, journeyType: string }, metadata: EventMetadata = createEventMetadata() as any) {
...
export class JourneyStageAdvanced extends DomainEvent<{ journeyId: string, oldStage: string, newStage: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journeyId: string, oldStage: string, newStage: string }, metadata: EventMetadata = createEventMetadata() as any) {
...
export class JourneyHealthUpdated extends DomainEvent<{ journeyId: string, healthScore: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journeyId: string, healthScore: number }, metadata: EventMetadata = createEventMetadata() as any) {
...
export class JourneyMilestoneAdded extends DomainEvent<{ journeyId: string, milestoneName: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journeyId: string, milestoneName: string }, metadata: EventMetadata = createEventMetadata() as any) {
...
export class JourneyPaused extends DomainEvent<{ journeyId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { journeyId: string }, metadata: EventMetadata = createEventMetadata() as any) {
