...
export class LeadCreated extends DomainEvent<{ leadId: string, email: string, source: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { leadId: string, email: string, source: string }, metadata: EventMetadata = {} as any) {
...
export class LeadQualified extends DomainEvent<{ leadId: string, qualifiedBy: string, score: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { leadId: string, qualifiedBy: string, score: number }, metadata: EventMetadata = {} as any) {
...
export class LeadDisqualified extends DomainEvent<{ leadId: string, reason: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { leadId: string, reason: string }, metadata: EventMetadata = {} as any) {
...
export class LeadAssigned extends DomainEvent<{ leadId: string, assigneeId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { leadId: string, assigneeId: string }, metadata: EventMetadata = {} as any) {
...
export class LeadConvertedToOpportunity extends DomainEvent<{ leadId: string, opportunityId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { leadId: string, opportunityId: string }, metadata: EventMetadata = {} as any) {
...
export class LeadConvertedToCustomer extends DomainEvent<{ leadId: string, customerId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { leadId: string, customerId: string }, metadata: EventMetadata = {} as any) {
...
export class LeadArchived extends DomainEvent<{ leadId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { leadId: string }, metadata: EventMetadata = {} as any) {
