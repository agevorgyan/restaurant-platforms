...
export class SkillsProfileCreated extends DomainEvent<{ profileId: string, staffId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, staffId: string }, metadata: EventMetadata = createEventMetadata()) {
...
export class SkillAdded extends DomainEvent<{ profileId: string, skillCode: string, skillLevel: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, skillCode: string, skillLevel: string }, metadata: EventMetadata = createEventMetadata()) {
...
export class SkillRemoved extends DomainEvent<{ profileId: string, skillCode: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, skillCode: string }, metadata: EventMetadata = createEventMetadata()) {
...
export class SkillLevelUpdated extends DomainEvent<{ profileId: string, skillCode: string, newLevel: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, skillCode: string, newLevel: string }, metadata: EventMetadata = createEventMetadata()) {
...
export class CertificationRegistered extends DomainEvent<{ profileId: string, certificationCode: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, certificationCode: string }, metadata: EventMetadata = createEventMetadata()) {
...
export class CertificationRenewed extends DomainEvent<{ profileId: string, certificationCode: string, expirationDate?: Date }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, certificationCode: string, expirationDate?: Date }, metadata: EventMetadata = createEventMetadata()) {
