...
export class RoleCreated extends DomainEvent<{ roleId: string, roleCode: string, roleName: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { roleId: string, roleCode: string, roleName: string }, metadata: EventMetadata = {}) {
...
export class RoleUpdated extends DomainEvent<{ roleId: string, roleName?: string, roleDescription?: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { roleId: string, roleName?: string, roleDescription?: string }, metadata: EventMetadata = {}) {
...
export class RoleActivated extends DomainEvent<{ roleId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { roleId: string }, metadata: EventMetadata = {}) {
...
export class PermissionAssigned extends DomainEvent<{ roleId: string, permissionCode: string, permissionScope: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { roleId: string, permissionCode: string, permissionScope: string }, metadata: EventMetadata = {}) {
...
export class PermissionRemoved extends DomainEvent<{ roleId: string, permissionCode: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { roleId: string, permissionCode: string }, metadata: EventMetadata = {}) {
...
export class RoleAssignedToStaff extends DomainEvent<{ roleId: string, staffId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { roleId: string, staffId: string }, metadata: EventMetadata = {}) {
