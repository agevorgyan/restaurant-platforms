...
export class TaxProfileCreated extends DomainEvent<{ profileId: string, employeeReference?: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, employeeReference?: string }, metadata: EventMetadata = {}) {
...
export class TaxProfileActivated extends DomainEvent<{ profileId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string }, metadata: EventMetadata = {}) {
...
export class TaxRuleAdded extends DomainEvent<{ profileId: string, ruleCode: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, ruleCode: string }, metadata: EventMetadata = {}) {
...
export class TaxRuleRemoved extends DomainEvent<{ profileId: string, ruleId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, ruleId: string }, metadata: EventMetadata = {}) {
...
export class TaxExemptionAdded extends DomainEvent<{ profileId: string, exemptionCode: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, exemptionCode: string }, metadata: EventMetadata = {}) {
...
export class TaxExemptionRemoved extends DomainEvent<{ profileId: string, exemptionId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { profileId: string, exemptionId: string }, metadata: EventMetadata = {}) {
