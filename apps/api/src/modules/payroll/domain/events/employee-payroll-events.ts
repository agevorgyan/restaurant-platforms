...
export class EmployeePayrollCreated extends DomainEvent<{ employeePayrollId: string, employeeReference: string, periodId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, employeeReference: string, periodId: string }, metadata: EventMetadata = {}) {
...
export class AttendanceImported extends DomainEvent<{ employeePayrollId: string, totalHours: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, totalHours: number }, metadata: EventMetadata = {}) {
...
export class GrossSalaryCalculated extends DomainEvent<{ employeePayrollId: string, grossAmount: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, grossAmount: number }, metadata: EventMetadata = {}) {
...
export class BonusApplied extends DomainEvent<{ employeePayrollId: string, bonusId: string, amount: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, bonusId: string, amount: number }, metadata: EventMetadata = {}) {
...
export class DeductionApplied extends DomainEvent<{ employeePayrollId: string, deductionId: string, amount: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, deductionId: string, amount: number }, metadata: EventMetadata = {}) {
...
export class TaxesCalculated extends DomainEvent<{ employeePayrollId: string, taxAmount: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, taxAmount: number }, metadata: EventMetadata = {}) {
...
export class NetSalaryCalculated extends DomainEvent<{ employeePayrollId: string, netAmount: number }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, netAmount: number }, metadata: EventMetadata = {}) {
...
export class EmployeePayrollApproved extends DomainEvent<{ employeePayrollId: string, approvedBy: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, approvedBy: string }, metadata: EventMetadata = {}) {
...
export class EmployeePayrollRejected extends DomainEvent<{ employeePayrollId: string, rejectedBy: string, reason: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, rejectedBy: string, reason: string }, metadata: EventMetadata = {}) {
...
export class EmployeePayrollFinalized extends DomainEvent<{ employeePayrollId: string, finalizedBy: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { employeePayrollId: string, finalizedBy: string }, metadata: EventMetadata = {}) {
