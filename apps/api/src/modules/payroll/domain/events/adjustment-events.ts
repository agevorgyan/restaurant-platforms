...
export class PayrollAdjustmentCreated extends DomainEvent<{ adjustmentId: string, employeeReference: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { adjustmentId: string, employeeReference: string }, metadata: EventMetadata = {}) {
...
export class PayrollAdjustmentUpdated extends DomainEvent<{ adjustmentId: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { adjustmentId: string }, metadata: EventMetadata = {}) {
...
export class PayrollAdjustmentApproved extends DomainEvent<{ adjustmentId: string, approvedBy: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { adjustmentId: string, approvedBy: string }, metadata: EventMetadata = {}) {
...
export class PayrollAdjustmentRejected extends DomainEvent<{ adjustmentId: string, rejectedBy: string, reason: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { adjustmentId: string, rejectedBy: string, reason: string }, metadata: EventMetadata = {}) {
...
export class PayrollAdjustmentCancelled extends DomainEvent<{ adjustmentId: string, cancelledBy: string }> {
  constructor(aggregateId: string, aggregateVersion: number, payload: { adjustmentId: string, cancelledBy: string }, metadata: EventMetadata = {}) {
